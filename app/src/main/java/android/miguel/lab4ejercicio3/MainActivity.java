...
public class MainActivity extends AppCompatActivity {
    ...
    public void consultaporcodigo(View v) {
        Intent i = new Intent(this, ConsultaCodigo.class );
        startActivity(i);
    ...
    public void consultapordescripcion(View v) {
        Intent i = new Intent(this, ConsultaDescripcion.class );
        startActivity(i);
    ...
    public void bajaporcodigo(View v) {
        Intent i = new Intent(this, BajaCodigo.class );
        startActivity(i);
    ...
    public void verRegistros(View v){
        Intent i = new Intent(this, VerRegistros.class );
        startActivity(i);
    }
}
